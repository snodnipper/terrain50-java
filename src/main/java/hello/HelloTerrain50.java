...
public class HelloTerrain50 {
    public static void main(String[] args) {
        ...
        String expected = "46";
        String actual = elevationService.getAltitude(easting, northing);
        assertEquals(expected, actual);

        easting = "406944";
        northing = "249990";
        expected = "27.9";
        actual = elevationService.getAltitude(easting, northing);
        assertEquals(expected, actual);
        ...
        expected = "34.2";
        actual = elevationService.getAltitude(eastingD, northingD);
        assertEquals(expected, actual);

        // TQ 9123 9678
        String gridRef = "TQ 9123 9678";
        actual = elevationService.getAltitude(gridRef);
        expected = "-1.7";
        assertEquals(expected, actual);
    }
