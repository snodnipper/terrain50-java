...
/**
 * Note to maintainer:
 * {@link uk.co.ordnancesurvey.elevation.impl.Strategy#MAX_PERFORMANCE} assumes a cloud server with
 ...
 * The {@link uk.co.ordnancesurvey.elevation.impl.Strategy#MAX_PERFORMANCE} option is in contrast
 * to a role where minimising resource use is the top priority, which can be specified by
 * {@link uk.co.ordnancesurvey.elevation.impl.Strategy#CONSERVE_RESOURCE}.  That profile may be more
