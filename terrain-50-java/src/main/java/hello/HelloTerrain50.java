...
public class HelloTerrain50 {
    public static void main(String[] args) {
        ...
        northing = "249990";
        expected = "27.9";
        actual = elevationService.getElevationFromBng(easting, northing);
        assertEquals(expected, actual);
        ...
        expected = "34.2";
        actual = elevationService.getElevationFromBng(eastingD, northingD);
        assertEquals(expected, actual);

        // TQ 9123 9678
        String gridRef = "TQ 9123 9678";
        actual = elevationService.getElevationFromBng(gridRef);
        expected = "-1.7";
        assertEquals(expected, actual);
    }
